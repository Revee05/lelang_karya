...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-footer">
                    <div class="float-right d-flex">
                        ...
                        <div class="d-block pl-2"> 
                            ...
                            <input type="text" name="kode_transaksi" value="{{$keluar->kode_transaksi}}" hidden>
                        </div>
                        <div class="d-block pl-2">
        ...
        <div class="col-sm-7">
            {{ Form::model($keluar, array('route' => array('transaksi.keluar.update', $keluar->id), 'method' => 'PUT')) }}
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <div class="d-block mr-auto">Barang keluar</div>
                ...
                <div class="card-body">
                    <div class="row pb-3">
                        <div class="col-sm-6">
                            <input type="date" name="out_date" class="form-control form-control-sm rounded-0" value="{{$keluar->out_date}}">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="buyer" class="form-control form-control-sm rounded-0" value="{{$keluar->buyer}}">
                        </div>
                        <div class="col-sm-12 mt-2">
                            <div class="text-xs">Catatan :</div>
                            <textarea class="form-control form-control-sm" name="note">{{$keluar->note}}</textarea>
                             <input type="text" name="kode_transaksi" value="{{$keluar->kode_transaksi}}" hidden>
                        </div>
