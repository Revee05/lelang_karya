...
@section('title','Create transaksi keluar')
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
            {{ Form::open(array('route' => 'transaksi.keluar.store')) }}
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row pb-3">
                        <div class="col-sm-6">
                            <input type="date" name="out_date" class="form-control form-control-sm rounded-0">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="buyer" class="form-control form-control-sm rounded-0" placeholder="Buyer">
                        </div>
