...
@section('title','Create transaksi masuk')
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-7">
            {{ Form::open(array('route' => 'transaksi.masuk.store')) }}
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row pb-3">
                        <div class="col-sm-6">
                            <input type="date" name="date_of_entry" class="form-control form-control-sm rounded-0">
                        </div>
                        <div class="col-sm-6">
                            <input type="text" name="supplier" class="form-control form-control-sm rounded-0" placeholder="Supplier">
                        </div>
