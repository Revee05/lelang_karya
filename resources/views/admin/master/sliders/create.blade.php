...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            {{ Form::open(array('route' => 'master.sliders.store','files'=>true)) }}
            <div class="card rounded-0 border-0 shadow">
                <div class="card-body">
                    ...
                    <div class="preview-cover">
                        <img class="border-1" @if(isset($karya) && $karya) src="{{asset('uploads/sliders/'.$karya->image)}}" @else src="{{asset('assets/img/default.jpg')}}" @endif id="foto-slider">
                    </div>
