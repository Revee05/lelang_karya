...
<div class="container-fluid">
    ...
    <h1 class="h5 mb-4 text-gray-800">Master 
        <small>slider</small>
        <a href="{{route('master.sliders.create')}}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus-circle"></i> Tambah slider</a>
    </h1>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('master.sliders.edit',$slider->id)}}" class="btn btn-sm btn-info rounded-0">
