...
<div class="container-fluid">
    ...
    <h1 class="h5 mb-4 text-gray-800">Master 
        <small>Seniman</small>
        <a href="{{route('master.karya.create')}}" class="btn btn-primary btn-sm float-right"><i class="fa fa-plus-circle"></i> Tambah Seniman</a>
    </h1>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$no++}}</td>
                            <td>{{ucfirst($karya->name)}}</td>
                            <td class="text-center">
                                <a href="{{route('master.karya.edit',$karya->id)}}" class="btn btn-sm btn-info rounded-0">
