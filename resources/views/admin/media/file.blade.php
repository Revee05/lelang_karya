  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12  col-sm-12">
        {{dd(config('lfm.folder_categories.image.max_size'))}}
            <iframe src="/admin/file?type={{$type}}" style="width: 100%; height: 650px; overflow: hidden; border: none;"></iframe>
        </div>
    </div>
  </div>
</div>
...
<body>
  ...
  <script>
    Dropzone.options.uploadForm = {
      ...
      acceptedFiles: "{{ lcfirst(str_singular(request('type') ?: '')) == 'image' ? implode(',', config('lfm.folder_categories.image.valid_mime')) : implode(',', config('lfm.folder_categories.file.valid_mime')) }}",
      maxFilesize: ({{ lcfirst(str_singular(request('type') ?: '')) == 'image' ? config('lfm.folder_categories.image.max_size') : config('lfm.folder_categories.file.max_size') }} / 1000)
    }
  </script>
</body>
</html>
